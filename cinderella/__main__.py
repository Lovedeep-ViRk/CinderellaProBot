...
SOURCE_STRING = """
⚡I'm built in python3, using the python-telegram-bot library, and am fully opensource - you can find what makes me tick [here](https://github.com/Lovedeep-ViRk/cinderella)
⚡You Can Clone Me [Here](https://heroku.com/deploy?template=https://github.com/Lovedeep-ViRk/cinderella.git)
"""
...
if START_IMG is None:
    img = "https://telegra.ph/file/880140f86c7f38d13ff4e.jpg"
else:
  img = START_IMG    
...
def send_start(bot, update):
    ...
    keyboard = [[InlineKeyboardButton(text="🤝Help",callback_data="help_back"),InlineKeyboardButton(text="👑Creator👨‍🔧",url="https://t.me/Lovedeep_ViRk")]]
...
def get_help(bot: Bot, update: Update):
    ...
    if chat.type != chat.PRIVATE:
        ...
        update.effective_message.reply_text("Contact me in PM to get the list of possible commands.",
                                            reply_markup=InlineKeyboardMarkup(
                                                [[InlineKeyboardButton(text="⚜️Help",url="t.me/{}?start=help".format(bot.username))],  
                                                [InlineKeyboardButton(text="👑Contact Creator",url="https://t.me/Lovedeep_ViRk")]]))
        return
